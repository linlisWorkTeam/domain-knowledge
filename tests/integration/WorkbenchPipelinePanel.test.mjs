...
for (const verified of [false, true]) test(`pipeline panel distinguishes execution completion from publication (${verified})`, async () => {
  ...
  const pipeline = { pipelineId: 'pipeline', contractVersion: 'knowledge-pipeline-v17', status: 'SUCCEEDED', currentStage: 'ASSOCIATE', children: {}, iterations: [], materialIds: [], fixedSuites: [{ moduleId: 'module' }] }
