...
export function createKnowledgeServer(input: {
  ...
  const server = createHttpServer(async (request, response) => {
    ...
    try {
      ...
      // GET /api/v1/agents/providers/status：读取模型提供方状态。
      ...
      // GET /api/v1/provider-settings：读取模型提供方配置。
      ...
      // GET /api/v1/metrics/runs：读取运行统计指标。
      ...
      // GET /api/v1/metrics/governance：读取治理统计指标。
      ...
      // GET /api/v1/system/capabilities：读取系统能力声明。
      ...
      // GET /api/v1/system/components：读取组件状态。
      ...
      // GET /api/v1/action-items：读取治理待办事项。
      ...
      // GET /api/v1/activity/stream：读取活动事件流。
      ...
      // GET /api/v1/evaluation-rules：读取评测规则。
