...
import { canonicalJson } from '../../src/domain/workbench/StageTask.ts';
...
import { assertNativeBehaviorSuite, nativeFunctions, type NativeContract } from '../../src/domain/evaluation/NativeBehaviorSuite.ts';
