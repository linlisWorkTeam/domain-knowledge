...
import { PIPELINE_CONTRACT, pipelineFixedFailure, pipelineSourceFailure, type WorkbenchPipeline } from '../../src/domain/workbench/WorkbenchPipeline.ts';
import { canonicalJson, type StageTask } from '../../src/domain/workbench/StageTask.ts';
...
const fixedSuite = JSON.parse(suiteBytes.toString('utf8')) as import('../../src/domain/evaluation/NativeBehaviorSuite.ts').NativeBehaviorSuite;
