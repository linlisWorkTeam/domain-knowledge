...
**规范状态：Accepted｜版本：1.7.1｜基线日期：2026-09-03**
...
前台交付 F1–F5 与系统实施 Phase 1–4 是两条独立编号轴。F2/B1 已完成实现与自动门禁，但 HCP-1 人工结论记录前不得进入 B2/B3 前台接线。原型中的模拟 Health、ETA、Activity、Action Item、Workspace 与用户身份不构成产品能力；Graph 只允许展示 Registry 中的真实 Agent 节点投影，新增后端或领域语义必须另行通过 Spec 对齐。
